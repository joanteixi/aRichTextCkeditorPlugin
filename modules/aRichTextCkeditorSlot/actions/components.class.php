<?php
class aRichTextCkeditorSlotComponents extends aSlotComponents
{
  public function executeEditView()
  {
    ...
    if (!isset($this->form))
    {
//      $this->form = new aRichTextCkeditorSlotEditForm($this->id, $this->slot->getArrayValue());
       $this->form = new aRichTextCkeditorSlotEditForm($this->id, $this->options);
