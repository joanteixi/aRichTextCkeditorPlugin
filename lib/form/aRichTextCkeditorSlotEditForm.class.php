<?php    
class aRichTextCkeditorSlotEditForm extends BaseForm
{
  protected $id;
  protected $soptions;
  ...
  {
    $widgetOptions = array();
    $toolbar = $this->consumeSlotOption('toolbar');
    $jsoptions = $this->consumeSlotOption('jsoptions');
    if (!is_null($toolbar))
    {
      $widgetOptions['toolbar'] = $toolbar;
    }
    if (!is_null($jsoptions))
    {
      $widgetOptions['jsoptions'] = $jsoptions;
    }
...
//    $this->setWidgets(array('value' => new aWidgetFormRichTextarea($widgetOptions, $this->soptions)));
    $this->setWidgets(array('value' => new sfWidgetFormCKEditor($widgetOptions, $this->soptions)));
